...
class TokoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'singkatan' => 'required|max:4|unique:toko,singkatan', // pastikan unik
            'id_level_harga' => 'required|array',
            'wilayah' => 'required|max:255',
            'alamat' => 'required|max:255',
            'pin' => 'nullable|numeric', // tidak wajib
            'tipe_kas' => 'nullable|in:umum,barang', // enum
        ], [
