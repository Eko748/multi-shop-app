...
@php
    $hasOmset = hasAnyPermission(['GET /get-omset']);
    $hasTransaksi = hasAnyPermission(['GET /get-jumlah-transaksi']);
    $hasLabaKotor = hasAnyPermission(['GET /get-laba-kotor']);
    $hasPenjualan = hasAnyPermission(['GET /get-top-penjualan']);
    $hasMember = hasAnyPermission(['GET /get-top-member']);
    $hasKomparasi = hasAnyPermission(['GET /get-komparasi-toko']);
    $hasRekap = hasAnyPermission(['GET /get-rekapitulasi-penjualan']);
