                                    ...
                                    <table class="table table-striped m-0">
                                        <thead>
                                            <tr class="tb-head">
                                                ...
                                                <th class="text-right text-wrap align-top"><span class="mr-4">Jumlah Item</span></th>
                                                <th class="text-right text-wrap align-top"><span class="mr-4">Jumlah Qty</span></th>
                                                <th class="text-right text-wrap align-top"><span class="mr-4">Total Nominal</span></th>
                                                <th class="text-right text-wrap align-top"><span class="mr-4">Total HPP</span></th>
                                                <th class="text-right text-wrap align-top"><span class="mr-4">Total Laba</span></th>
                                            </tr>
                                        </thead>
                                        <tbody id="listData">
                                        </tbody>
        ...
        async function setListData(dataList, pagination) {
            ...
            dataList.forEach((element, index) => {
                ...
                <tr class="text-dark">
                    ...
                    <td class="${classCol} text-right"><span class="mr-4">${element.total_trx}</span></td>
                    <td class="${classCol} text-right"><span class="mr-4">${element.total_barang_dibeli}</span></td>
                    <td class="${classCol} text-right"><span class="mr-4">${formatRupiah(element.total_pembayaran)}</span></td>
                    <td class="${classCol} text-right"><span class="mr-4">${formatRupiah(element.total_hpp)}</span></td>
                    <td class="${classCol} text-right"><span class="mr-4">${formatRupiah(element.laba)}</span></td>
                </tr>`;
            });
