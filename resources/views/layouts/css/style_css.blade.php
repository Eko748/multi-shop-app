    ...
    <style>
        /* Sesuaikan ukuran font dan padding nav-link Able Pro */
        ...
        /* Mengubah layout agar menu fleksibel jika layar masih kurang lebar */
        .pcoded-navbar.theme-horizontal .pcoded-inner-navbar {
            display: flex !important;
            flex-wrap: wrap !important;
            /* Menu otomatis melipat ke bawah secara rapi jika tidak muat */
        }

        /* 1. Ratakan kotak submenu paling kanan (misal: Jurnal Keuangan & Laporan Keuangan) ke sisi kanan induknya */
        ...
        .pcoded-navbar.theme-horizontal .pcoded-inner-navbar>li.pcoded-hasmenu:nth-last-child(2) .pcoded-submenu {
            ...
            /* Mencegah JS bawaan Able Pro menariknya ke tengah */
        }

        /* 2. Pindahkan panah kecil (arrow) di atas submenu agar bergeser ke kanan mengikuti posisinya */
        ...
        .pcoded-navbar.theme-horizontal .pcoded-inner-navbar>li.pcoded-hasmenu:nth-last-child(2)>.pcoded-submenu:before {
            left: auto !important;
            right: 5px !important;
            /* Pas di bawah tombol utama */
        }

        /* 3. Rapikan panah kecil sisi (chevron/arrow) di dalam list jika ada */
        ...
        /* Membuat submenu Data Master menjadi 2 kolom menyamping */
        ...
        .pcoded-navbar.theme-horizontal .pcoded-submenu>li.font-weight-bold {
            width: 100% !important;
        ...
        /* Setiap item menu mengambil 50% lebar (2 kolom) */
        .pcoded-navbar.theme-horizontal .pcoded-submenu>li:not(.font-weight-bold) {
            width: calc(50% - 10px) !important;
        }

        .pcoded-navbar.theme-horizontal .pcoded-submenu>li:not(.font-weight-bold)>a:hover {
            color: #10b981 !important;
            /* Warna teks berubah mint/teal */
            background: #ffffff !important;
            /* Kombinasi shadow soft neumorphism + inset halus */
