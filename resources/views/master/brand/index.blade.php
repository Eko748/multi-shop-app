                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12 col-xl-2 col-lg-2 mb-2">
                                    @if (hasAnyPermission(['POST /brand/post']))
                                    ...
                                    <table class="table table-striped m-0">
                                        <thead>
                                            <tr class="tb-head">
                                                ...
                                                <th class="text-wrap align-top">ID Brand</th>
                                                <th class="text-wrap align-top">Nama Brand</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel">Tambah Data Brand</h5>
...
@section('js')
    <script>
        ...
        async function handleData(data) {
            let edit_button = '';
            let delete_button = '';
            if (hasPermission(['PUT /brand/put'])) {
                edit_button = `
            ...
            if (hasPermission(['DELETE /brand/delete'])) {
                delete_button = `
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_brand" name="nama_brand" placeholder="Masukkan brand" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
