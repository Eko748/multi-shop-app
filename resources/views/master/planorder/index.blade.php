        ...
        async function setListData(dataList, pagination, dynamicKeys = [], tokoMap = {}) {
            ...
            let subHeaders = dynamicKeys.map((key, index) => {
                ...
                return `
                    ...
                    style="background: linear-gradient(to bottom, #a8e6a1, #66ff66); width: 1px; white-space: nowrap; padding-left: 4px; padding-right: 4px; cursor: pointer;">
                ...
                <th class="text-wrap align-top text-center sortable-col header-${index}-otw ${activeOtw}"
                    ...
                    style="background: linear-gradient(to bottom, #fff9a1, #ffff33); width: 1px; white-space: nowrap; padding-left: 4px; padding-right: 4px; cursor: pointer;">
                    <div class="d-flex align-items-center justify-content-center">
                ...
                <th class="text-wrap align-top text-center sortable-col header-${index}-lo ${activeLo}"
                    ...
                    style="background: linear-gradient(to bottom, #a1e9ff, #00ccff); width: 1px; white-space: nowrap; padding-left: 4px; padding-right: 4px; cursor: pointer;">
                    <div class="d-flex align-items-center justify-content-center">
