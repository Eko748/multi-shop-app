                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-border-style">
                            <div class="table-responsive">
                                <form action="{{ route('master.toko.update', $toko->id) }}" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="nama_toko" class=" form-control-label">Nama Toko<span
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="singkatan" value="{{ old('singkatan', $toko->singkatan) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="password" id="pin" name="pin"
                                                    placeholder="Masukkan PIN" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="id_level_harga" class="form-control-label">Level Harga<span
                                                        style="color: red">*</span></label>
                                                <select class="form-control" id="id_level_harga" name="id_level_harga[]"
                                                    multiple>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('wilayah') is-invalid @enderror"
                                            name="wilayah" value="{{ old('wilayah', $toko->wilayah) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat" id="alamat" rows="4" @error('alamat') is-invalid @enderror" name="alamat"
                                            class="form-control">{{ old('alamat', $toko->alamat) }}</textarea>
                                    </div>
                                    <br>
                                    <div class="form-group">
