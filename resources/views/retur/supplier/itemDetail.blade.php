<script>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="align-middle">
                                            <i class="fa fa-user text-primary mr-2"></i> <strong>Suplier</strong>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="align-middle" style="width: 20%;">
                                            <i class="fa fa-tags text-primary mr-2"></i> <strong>Total Refund</strong>
                                        </td>
                                        <td class="align-middle">: ${data.total_refund}</td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle">
    ...
    async function handleData2(data) {
        return {
            ...
            format_selisih: data?.format_selisih ?? '-',
                        ...
                        <table class="table table-hover m-0">
                            <thead class="glossy-thead">
                                <tr>
                                    ...
                                    <th scope="col" class="${tdClass}" style="width:20%">Qty Retur</th>
                                    <th scope="col" class="${tdClass} text-right" style="width:10%">Total Hpp</th>
                                    <th scope="col" class="${tdClass} text-right" style="width:10%">Total Refund</th>
                                    <th scope="col" class="${tdClass} text-right" style="width:10%">Selisih</th>
                                    <th scope="col" class="${tdClass} text-right" style="width:10%">Status</th>
                                </tr>
                            </thead>
                            <tbody>`;
        ...
        dataList.forEach((element, index) => {
            ...
            getDataTable += `
                <tr class="glossy-tr">
                    ...
                    <td class="${tdClass}"><details><summary>${element.barang}</summary><p>Harga Jual: ${element.format_harga_jual}</p></details></td>
                    <td class="${tdClass} text-left">${element.tipe_kompensasi}</td>
                    <td class="${tdClass} text-left"><details><summary>${element.qty_request}</summary><ul><li>Refund: ${element.qty_refund} (${element.format_jumlah_refund})</li><li>Barang: ${element.qty_barang} (${element.format_hpp})</li></ul></details></td>
                    <td class="${tdClass} text-right">${element.format_total_hpp}</td>
                    <td class="${tdClass} text-right">${element.format_total_refund}</td>
                    <td class="${tdClass} text-right">${element.format_selisih}</td>
                    <td class="${tdClass} text-right">${element.status}</td>
                </tr>
            `;
        });
