                                    ...
                                    <div class="table-responsive-md">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($pengiriman_barang->detail as $detail)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-wrap">
                                                            {{ $detail->supplier?->nama_supplier ?? 'Tidak ada' }}</td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th scope="col"
                                                        colspan="{{ $pengiriman_barang->status !== 'success' ? '7' : '6' }}"
                                                        class="text-right text-wrap">SubTotal
                                                    </th>
            ...
            $(document).on("click", "#save-data", async function(e) {
                ...
                swal({
                    ...
                    const formData = {
                        ...
                        id_retur: '{{ $pengiriman_barang->id_retur }}' ? JSON.parse(
                            '{!! $pengiriman_barang->id_retur !!}').map(Number) : null,
                    };
