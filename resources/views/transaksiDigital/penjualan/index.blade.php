...
@section('css')
    ...
    <style>
        ...
        /* Desktop: batasi max width */
        @media (min-width: 768px) {
            .filter-input {
                max-width: 300px;
                /* bisa kamu ubah sesuai selera */
            }
        }
    </style>
@endsection
...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content pt-1 mt-1">
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-3 mb-2">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card shadow-sm border-0 m-0 rounded glossy-card bg-light h-100">
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div>
                                        <h5 class="m-0">
                                            <i class="fa fa-wallet mr-1 text-primary"></i> Sisa Saldo Digital
                                        </h5>
                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-9 mb-2">
...
@section('js')
    <script>
        ...
        let selectOptions = [{
            id: '#item_nonfisik',
            isUrl: '{{ route('td.itemNonfisik.getNama') }}',
    ...
    @include('transaksiDigital.penjualan.item')
    @include('transaksiDigital.penjualan.itemDetail')
    @include('transaksiDigital.penjualan.saldo')
