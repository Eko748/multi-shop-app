...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        // Reture Suplier Controller
        Route::get('/reture/suplier', [RetureSuplierController::class, 'index'])->name('reture.suplier.index')->middleware('permission:GET /reture/suplier');
        Route::post('/reture/suplier/store', [RetureSuplierController::class, 'store'])->name('reture.suplier.store')->middleware('permission:POST /reture/suplier/store');
        Route::delete('/reture/suplier/delete', [RetureSuplierController::class, 'delete'])->name('reture.suplier.delete')->middleware('permission:DELETE /reture/suplier/delete');
        ...
        Route::get('/asetbarang-reture', [AssetBarangRetureController::class, 'index'])->name('laporan.asetbarangreture.index')->middleware('permission:GET /asetbarang-reture');
